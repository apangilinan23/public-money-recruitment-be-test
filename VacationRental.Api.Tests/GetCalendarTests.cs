...
namespace VacationRental.Api.Tests
{
    ...
    public class GetCalendarTests
    {
        ...
        public async Task GivenCompleteRequest_WhenGetCalendar_ThenAGetReturnsTheCalculatedCalendar()
        {
            ...
            using (var getCalendarResponse = await _client.GetAsync($"/api/v1/calendar?rentalId={postRentalResult.Id}&start=9999-01-01&nights=5"))
            {
                ...
                Assert.Equal(new DateTime(9999, 01, 01), getCalendarResult.Dates[0].Date);
                Assert.Empty(getCalendarResult.Dates[0].Bookings);
                
                Assert.Equal(new DateTime(9999, 01, 02), getCalendarResult.Dates[1].Date);
                ...
                Assert.Equal(new DateTime(9999, 01, 03), getCalendarResult.Dates[2].Date);
                ...
                Assert.Equal(new DateTime(9999, 01, 04), getCalendarResult.Dates[3].Date);
                ...
                Assert.Equal(new DateTime(9999, 01, 05), getCalendarResult.Dates[4].Date);
